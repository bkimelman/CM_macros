...
void calcVertices(int nStripes, int nPads, std::array<double, nRadii>& R, std::array<int, nRadii>& keepUntil, double x[][nRadii], double y[][nRadii], std::array<int, nRadii>& nGoodStripes){
...
void getAllVert(){
  ...
  calcVertices(nStripes_R1,nPads_R1,R1_e,keepUntil_R1_e,x_R1e,y_R1e,nGoodStripes_R1_e);
  calcVertices(nStripes_R1,nPads_R1,R1,keepUntil_R1,x_R1,y_R1,nGoodStripes_R1);
  calcVertices(nStripes_R2,nPads_R2,R2,keepUntil_R2,x_R2,y_R2,nGoodStripes_R2);
  calcVertices(nStripes_R3,nPads_R3,R3,keepUntil_R3,x_R3,y_R3,nGoodStripes_R3);
